package org.coding.backJoon.gold.p18428;
...
//        }
//
//        System.out.println(btr(0) ? "YES" : "NO");
//
//    }
//
//    private static boolean btr(int depth) {
//        if (depth == 3){
//            return dfs();
//        }
//
...
//            int y = teacher.get(1);
//            for (int i = 0 ; i < 4; i++){
//                if (!processDirection(x, y, dx[i], dy[i])){
//                    return false;
//                }
//            }
//        }
...
//    }
//
//    private static boolean processDirection(int x, int y, int dx, int dy) {
//        x += dx;
//        y += dy;
//        while (x >= 0 && x < n && y >= 0 && y < n && map[x][y] != 'O') {
//            if (map[x][y] == 'S') {
